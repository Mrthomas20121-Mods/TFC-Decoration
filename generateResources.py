...
def sandstone_recipe(filename_parts, rock_type) :
    shapeless_recipe(filename_parts, [{'item': 'tfc:sand/'+rock_type}, {'item': 'tfc:sand/'+rock_type}, {'item': 'tfc:sand/'+rock_type}, {'item': 'tfc:sand/'+rock_type}], 'tfc_decoration:sandstone/'+rock_type)
...
for rock_type in ROCK_TYPES:
    ...
    shapeless_recipe(('stone', rock_type, rock_type+'_mud_ball'), [{'item':'tfc:straw'}, {'item':'tfc:dirt/'+rock_type}, {'item':'minecraft:clay'}], 'tfc_decoration:mud_ball/'+rock_type);
