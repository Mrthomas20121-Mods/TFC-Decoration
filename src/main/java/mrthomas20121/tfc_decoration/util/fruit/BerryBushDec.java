package mrthomas20121.tfc_decoration.util.fruit;
...
public enum BerryBushDec implements IBerryBush
{
    PINEAPPLE(() -> ItemsDec.pineapple, Month.JANUARY, 12, -5f, 17f, 100f, 400f, 0.8f, LARGE, true);
    ...
    BerryBushDec(Supplier<Item> fruit, Month harvestMonthStart, int harvestingMonths, float minTemp, float maxTemp, float minRain, float maxRain, float growthTime, Size size, boolean spiky)
    {
        this.fruit = fruit;
